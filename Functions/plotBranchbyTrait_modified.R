plotBranchbyTrait<-function(tree,x,mode=c("edges","tips","nodes"),palette="rainbow",legend=TRUE,xlims=NULL,...){
        ...
        # now plot
        xx<-plot.phylo(tree,show.tip.label=T,show.node.label=F,edge.color=colors,
                       edge.width=edge.width,edge.lty=edge.lty,font=font,cex=cex,adj=adj,srt=srt,no.margin=T,root.edge=root.edge,
                       label.offset=label.offset,underscore=underscore,x.lim=x.lim,y.lim=y.lim,lab4ut=lab4ut,

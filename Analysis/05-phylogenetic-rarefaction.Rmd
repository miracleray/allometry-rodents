...
par(mar = c(5, 4, 0, 1))
plot(c(1:length(med.delta.slopes)), angle.changes, xlab = "Clade number (see fig. 1) or species name", ylab = expression(paste("Median ", Delta, " angle (\u00B0)")), pch = 16, ylim = c(0,90), xaxt = 'n', cex.axis = 1)
axis(side = 1, at = c(1:73), labels = new.names, las = 2, cex.axis = 0.45)
text(0.5, 85, "B", cex = 2)

...
### Load packages, functions, and data; set font for figures
```{r message = FALSE}
library(geomorph)
...
quartzFonts(helvetica = c("Helvetica Regular", "Helvetica Bold", "Helvetica Oblique", "Helvetica Bold Oblique"))
```
...
out.cols <- c(col.phylo["Mel"], col.phylo["Mes"], col.phylo["Not"], col.phylo["Pse"], col.phylo["Leg"], col.phylo["Rat"])
...
axis(side = 1, at = c(1:73), labels = new.names, las = 2, cex.axis = 0.55)
text(0.5, 85, "B", cex = 1.5)
abline(h = 4.5, col = "deeppink4")  # significance level
text(1, 7, "4.5\u00B0 significance level", adj = c(0,0), col = "deeppink4")
legend("topright", out.names, col = out.cols, pch = 16)
...
setEPS()
postscript("../Data/Results/FigureA2_RandomClades.eps")

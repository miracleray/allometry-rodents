...
We decided that 4.5 degrees is an ideal cut-off because absolute value of angle change can only vary from 0-90 therefore a 5% variation from 90 is 90*0.5 = 4.5 degrees.
```{r}

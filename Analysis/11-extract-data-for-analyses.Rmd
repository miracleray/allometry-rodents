---
title: "11-extract-data-for-analyses"
author: "Ariel Marcy"
date: "9/17/2018"
...
The custom functions written for these analysese are defined in the utilities.R file for conciseness.
```{r message = FALSE}
library(dplyr)
library(stringr)
library(stringi)
...
```{r}
save(big.bY.shape, big.sp.info, rep.spec, big.pt.names, big.sp.info, file = "../Data/Processed/01-bilat-big-data-w-ERR.rda")
save(sm.bY.shape, sm.sp.info, rep.spec, sm.pt.names, sm.sp.info, file = "../Data/Processed/01-bilat-sm-data-w-ERR.rda")
```
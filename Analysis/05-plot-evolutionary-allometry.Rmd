...
### Isolate molecular rates used for phylogeny in paper
```{r}
...
# Plot branches by trait, molecular rate of evolution
...
postscript("../Data/Results/Figure2_EvoAllo_PhyloPCA.eps")

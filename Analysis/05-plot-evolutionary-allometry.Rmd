...
# Phylomorphospace
plotGMPhyloMorphoSpace_plotmod(aus.tree, mean.shapes.tree, xaxis = -1, tip.labels = F, node.labels = F, plot.param = list(t.bg = col.means, t.pch = pch.means, t.cex = 1.5, n.cex = .75, l.col = gray.branches.10, l.wd = 0.25, main = "b) PCA Phylomorphospace", xlab = PC1.lab, ylab = PC2.lab))

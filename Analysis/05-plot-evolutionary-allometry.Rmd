...
legend(5.81, 0.052, legend = genera.phylo, col = col.phylo, pch = 16, cex = 1, pt.cex = 1, ncol = 2)
...
# Phylomorphospace
plotGMPhyloMorphoSpace_plotmod(aus.tree, mean.shapes.tree, xaxis = -1, tip.labels = F, node.labels = F, plot.param = list(t.bg = col.means, t.pch = pch.means, t.cex = 1.5, n.cex = .75, l.col = gray.branches.10, l.wd = 0.15, main = "b) PCA Phylomorphospace", xlab = PC1.lab, ylab = PC2.lab))
...
rasterImage(legend_image, -0.07, -0.05, -0.04, -0.04)
text(-0.055, -0.035, "Faster rate", col = "dark grey", cex = 0.7)
text(-0.055, -0.053, "Slower rate", col = "dark grey", cex = 0.7)

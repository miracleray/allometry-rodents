...
evo.allo.clade.2 <- procD.lm(Shape ~log(size) * Clade, iter = 500, data = evo.allo.clade.gdf)
...
pairwise.clade.simple <- pairwise(evo.allo.clade, groups = evo.allo.clade.gdf$Clade)

summary(pairwise.clade.simple, confidence = 0.95, test.type = "VC", angle.type = "deg")  # correlation between mean vectors (angles in degrees)

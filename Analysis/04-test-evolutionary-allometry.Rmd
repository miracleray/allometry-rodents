...
evo.allo.clade.gdf <- geomorph.data.frame(Shape = mean.shapes.tree, size = info.means.tree$MeanCsize, Clade = info.means.tree$Clade)

evo.allo.clade <- procD.pgls(Shape ~log(size) * Clade, aus.tree, iter = 500, data = evo.allo.clade.gdf)

...
cs.tree <- -info.means$MeanCsize  # negative so colors get darker with larger size
...
evo.procD <- geomorph.data.frame(shape = mean.shapes.tree, size = info.means$MeanCsize, genus = info.means$Genus)

...
```{r}
# Phylomorphospace for supplementary materials  
gray.branches.10 <- rep("dark gray", length(gray.branches.10)) # STOP-GAP MEASURE to handle decision to no longer color the branches

...
text(.085, 0.041, "Herbivores", col = "dark blue")
draw.ellipse(.048, .035, .025, .013, angle = -19, border = "dark blue")
...
draw.ellipse(5.92, .115, .08, .005, angle = 1, border = "darkgoldenrod4")

text(5.35, 0.08, "Herbivores", col = "dark blue")
draw.ellipse(5.41, .047, .11, .02, angle = 5, border = "dark blue")

text(5.81, 0.075, "Carnivore", col = "red")
text(5.03, 0.02, "Carnivore", col = "orange")

text(5.3, -0.065, "Hopping Notomys", col = "blue")
draw.ellipse(5.12, -0.055, .075, .012, angle = 8, border = "blue")

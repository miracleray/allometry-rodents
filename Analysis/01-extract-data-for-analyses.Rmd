...
The dataset contains two different shape datasets from two different landmarking protocols. This study, however, uses just one protocol, the small patch dataset as shown in the supplementary material of the paper. 
```{r}
...
The two bilateral GPAs can take some time (~5min total to run).

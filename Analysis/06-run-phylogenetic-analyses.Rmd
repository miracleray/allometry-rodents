...
info.phylo <- info.traits[, c(1:4, 8, 9, 11, 12)]
```
...
info.means <- info.phylo[!duplicated(info.phylo$Taxa), -c(4, 5)]  # make metadata; remove columns that don't make sense: CatNum and Order

...
actual.pw.T <- length(which(round(pw.summary$pairwise.tables$P, 3) < 0.01))
...
hist((count.pw.1[1:length(count.pw)])/2, main = NULL, xlab = "Significant pairwise comparisons (alpha < 0.01)")
...
summary(pairwise.clade, confidence = 0.99, test.type = "VC", angle.type = "deg")  # correlation between mean vectors (angles in degrees)
```

...
We do this with two different ANCOVAs, one with a phylogenetic reference and one without. 
...
write.table(table2_n317, "../Data/Results/Table1b_ANOVA_clade.csv", sep = ",", col.names = NA)
```

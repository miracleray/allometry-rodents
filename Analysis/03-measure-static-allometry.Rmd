...
col.phylo <- c(Uro[2], Uro[1], Con[1], Con[2], Con[3], Pse[3], Pse[4], Pse[1], Pse[2], Hyd[2], Hyd[1], Pog[3], Inv[3], Inv[1])
...
text(5.6, -0.04, paste("Rsq of log(size) = ", round(spp.results$aov.table$Rsq[1], 2)), cex = 0.8, col = "dark grey")
...
text(5.6, -0.08, paste("Rsq of log(size):species = ", round(spp.results$aov.table$Rsq[3], 2)), cex = 0.8, col = "dark grey")
dev.off()
```

### Save intermediate data
```{r}
save(col.gen, sp.col.gen, col.phylo, names.phylo, spp.results, file = "../Data/Processed/03-color-data.rda")
```
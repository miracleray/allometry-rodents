...
#-pca.means$pc.scores[, 1], pca.means$pc.scores[, 2]
...
colnames(rare.table) <- c("FullName", "Csize", "PredVal")
...
```{r}
# Getting the rarefied statistics for each clade
delta_slopes_overall <- lapply(data_clades, rarefy.stat, stat.fun = my_function, rarefaction = 5, observed = my_function(rare.table[, c(2, 3)]))
```

...
TestHOS <- function(shape, size, spp, iter = 500, lm.fun) {
        # Data frame
...
spp.results <- procD.allometry(shape ~ log(size), f2 = ~Species, iter = 500, data = spp.gdf)
...
```{r}
save(spp.results, file = "../Data/Processed/04-allometry-data.rda")
```

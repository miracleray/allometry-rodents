...
legend(6.03, 0.051, legend = info.means$Taxa, col = col.means, border = NULL, pch = pch.means, pt.bg = col.means, cex = 0.51, ncol = 2)
```
...
plot(x = log(gen.results$size),
     ...
     xlab = "Log centroid size", 
     ylab = "Predicted shape (CAC)")
legend(6.04, 0.12, legend = names.phylo, col = col.phylo, pch = 16, cex = 0.7)
```

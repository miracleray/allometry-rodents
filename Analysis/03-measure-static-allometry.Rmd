...
col.unique.spp <- PlotByGroup(info, "EGenus", col.gen)
...
legend(6.04, 0.15, legend = sort(unique(info$Taxa)), col = col.unique.spp, border = NULL, pch = pch.unique.spp, pt.bg = col.unique.spp, cex = 0.63, ncol = 3)
```

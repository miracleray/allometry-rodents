...
Run allometry tests as well as a homogeneity of slopes test. These tests take about 5 min to run. Updated for `geomorph` 3.1.0
```{r}
...
summary(pw.comp, test.type = "dist", confidence = 0.95)
...
write.csv(pwHOS.spp$P.slopes.dist, "../Data/Results/TableS4_HOS.csv")


## Null expantcy for significant results

## Shuffle species attributions
null.pairwise <- function() {
        spp <- sample(info.HOS$Taxa)

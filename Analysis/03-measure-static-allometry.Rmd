...
```{r, fig.width = 12, fig.height = 12}
# An empty plot first
fake.results.list <- apply(fake.results.table, 2, as.list)
plot(NULL, xlim = c(0, length(fake.results.list)), ylim = c(-50, 50))
     
# Adding the results
plot.CI(unlist(fake.results.list, recursive = FALSE), type = "polygon", CI = c(5, 5), cent.tend = median)

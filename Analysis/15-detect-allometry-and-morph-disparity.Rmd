---
title: "15-detect-allometry-and-morph-disparity"
author: "Ariel Marcy"
date: "10/17/2018"
...
## Static allometry
```{r}
# Re-order species to be in closely related groups
info.traits2 <- info.traits[order(info.traits$Clade, info.traits$Genus, info.traits$Species, info.traits$CatNum), ]

# Run pair-wise slope test
...
pw.pvalues <- pairwiseHOS.spp$P.slopes.dist
pw.pvalues[lower.tri(pw.pvalues)] <- NA
pw.adj <- p.adjust(pw.pvalues, method = "BY")

# Export P values
write.csv(pw.adj, "../Data/Results/static_allometry_pairwise_comp.csv")  # save in Results folder
```

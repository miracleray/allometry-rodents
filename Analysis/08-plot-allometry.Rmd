...
mtext("         Millions of years ago", 1, line = 1, col = "black")
...
text(5.6, -0.08, bquote(R^2 ~ "of log(size):species = " ~ .(r.stat3)), cex = 1.1, col = "black")

dev.off()

#text(5.6, -0.08, expression(paste("R^2"," of log(size):species = "), round(fit.static$aov.table$Rsq[3], 2)), cex = 1.1, col = "black")
```
...
legend("bottomright", inset = c(0.026, 0), legend = gen.phylo.new, col = col.phylo.new, pch = pch.phylo.new, cex = 0.9, pt.cex = 0.95, ncol = 3, bty = "n")

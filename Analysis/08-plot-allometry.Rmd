...
# Insert (Pseudomys) into name for Mastacomys
mas.index <- which(aus.tree$tip.label == "Mastacomys_fuscus")
aus.tree$tip.label[mas.index] <- paste("Mastacomys_(Pseudomys)_fuscus")
```
...
```{r}
pdf("../Data/Results/Figure1_Phylogeny_Chapter1.pdf")
...
# Denote the Pseudomys affiliation for Mastacomys fuscus
leg.names[which(leg.names == "M. fuscus")] <- "M. (P.) fuscus"
```

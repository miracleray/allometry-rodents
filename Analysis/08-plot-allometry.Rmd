...
text(-.066, 0.025, "Notomys", col = col.gen[which(names(col.gen) == "Not")])
...
text(0, dim(dor1)[1]-10, "D", cex = 1.5)
...
text(0, dim(lat1)[1]-10, "E", cex = 1.5)
...
text(387, 197, "High variation", col = "grey55", cex = 1)
